...
function CustomDrawerContent(props: any) {
  ...
  const handleConnectGithub = async () => {
    ...
    try {
      ...
      alert('Token inválido ou erro de conexão.');
      const { GithubService } = await import('../services/GithubService');
      ...
      {isEditor ? (
        ...
        {githubUser ? (
          ...
          <>
            ...
            <View style={styles.userInfo}>
              <Text style={styles.userName}>Conectar GitHub</Text>
              <Text style={styles.userSub}>Sincronize repositórios</Text>
            </View>
          </>
        )}
      </TouchableOpacity>
      ...
      <View style={styles.menuSection}>
        {MENU_OPTIONS.map(opt => (
          ...
          >
            ...
            <Text style={styles.menuOptionText}>{opt.label}</Text>
          </TouchableOpacity>
        ))}
      </View>
      </>
      ...
      <Modal visible={showGithubModal} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>Conectar ao GitHub</Text>
            <Text style={styles.modalSub}>
              Para acessar seus repositórios, insira um Personal Access Token (classic) com permissão de "repo".
            </Text>
            <TextInput
            ...
            <View style={styles.modalActions}>
              ...
              <TouchableOpacity style={styles.modalBtnPrimary} onPress={handleConnectGithub}>
                <Text style={styles.modalBtnTextPrimary}>{isLoading ? 'Conectando...' : 'Conectar'}</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
