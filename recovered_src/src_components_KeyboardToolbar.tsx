...
export const KeyboardToolbar: React.FC<KeyboardToolbarProps> = ({ onAction }) => {
  ...
  // NEVER render when not visible or not in an editor/terminal
  if (!isVisible || !isEditorActiveRef.current) return null;
