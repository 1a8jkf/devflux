...
Extensão oficial do **DevFlux** para Visual Studio Code.

## Funcionalidades

- **Live Sync Engine**: Transmite as edições de arquivos feitas no VS Code diretamente para o seu aplicativo DevFlux Mobile via WebSocket em tempo real.
...
3. Digite `DevFlux: Start Live Sync Server` e dê Enter.
4. Uma notificação com o seu IP local irá aparecer. O botão "DevFlux Sync" ficará verde na sua barra de status (rodapé).
5. No app DevFlux, vá em "Live Sync" e conecte-se usando o IP fornecido.
